            ...
            <div className=" w-full max-w-6xl mx-auto choose-card">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 ">
                    <div
                        ...
                        data-aos-duration="800"
                        data-aos-anchor-placement="center-bottom"
                        className="bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md px-4 py-8 rounded-md w-full shadow shadow-[#0005] dark:shadow-[#0009] chooseCard ">
                        <IoAccessibilitySharp className="text-4xl text-pink-400 chooseIcon duration-300" />
                    ...
                    <div
                        ...
                        data-aos-anchor-placement="center-bottom"
                        className="bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md px-4 py-8 rounded-md w-full shadow shadow-[#0005] dark:shadow-[#0009] chooseCard">
                        <FaUserGraduate className="text-4xl text-pink-400 chooseIcon duration-300" />
                    ...
                    <div
                        ...
                        data-aos-duration="800"
                        data-aos-anchor-placement="center-bottom"
                        className="bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md px-4 py-8 rounded-md w-full shadow shadow-[#0005] dark:shadow-[#0009]chooseCard chooseCard">
                        <FaUsers className="text-4xl text-pink-400 chooseIcon duration-300" />
                    ...
                    <div
                        ...
                        data-aos-anchor-placement="center-bottom"
                        className="bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md px-4 py-8 rounded-md w-full shadow shadow-[#0005] dark:shadow-[#0009]chooseCard chooseCard">
                        <MdLocalOffer className="text-4xl duration-300 text-pink-400 chooseIcon" />
                    ...
                    <div
                        ...
                        data-aos-anchor-placement="center-bottom"
                        className="bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md px-4 py-8 rounded-md w-full shadow shadow-[#0005] dark:shadow-[#0009]chooseCard chooseCard">
                        <GiSkills className="text-4xl duration-300 text-pink-400 chooseIcon" />
                    ...
                    <div
                        ...
                        data-aos-anchor-placement="center-bottom"
                        className="bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md px-4 py-8 rounded-md w-full shadow shadow-[#0005] dark:shadow-[#0009]chooseCard chooseCard">
                        <GiConfirmed className="text-4xl duration-300 text-pink-400 chooseIcon" />
