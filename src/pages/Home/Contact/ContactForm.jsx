...
const ContactForm = () => {
    ...
    return (
        <form ref={form} onSubmit={sendEmail} className=" py-6 px-4 md:px-10 rounded-md bg-darkColor bg-opacity-15 backdrop-blur-md dark:bg-lightColor dark:bg-opacity-20 dark:backdrop-blur-md w-full shadow shadow-[#0005] dark:shadow-[#0009] ">
            <div className="py-3">
